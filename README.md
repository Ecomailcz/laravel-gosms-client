...
```php
use EcomailGoSms\Laravel\GoSmsFacade as GoSms;use EcomailGoSms\Messages\Sms;
...
$client->sendMessagesAsync([
    new Sms('Shared text', 1, '+420123456789', 'batch-1'),
    new Sms('Shared text', 1, '+420987654321', 'batch-2'),
]);
```
